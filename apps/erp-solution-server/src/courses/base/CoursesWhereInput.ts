...
import { ExamsListRelationFilter } from "../../exams/base/ExamsListRelationFilter";

@InputType()
class CoursesWhereInput {
  @ApiProperty({
    required: false,
    type: StringFilter,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => ExamsListRelationFilter,
  })
  @ValidateNested()
  @Type(() => ExamsListRelationFilter)
  @IsOptional()
  @Field(() => ExamsListRelationFilter, {
    nullable: true,
  })
  examsItems?: ExamsListRelationFilter;
}

export { CoursesWhereInput as CoursesWhereInput };
